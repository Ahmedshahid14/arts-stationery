...
$users = "SELECT * FROM `login` WHERE `username`= '{$username}'";
      ...
      <aside class="sidebar-wrapper">
          <div class="sidebar-header mb-5">
            <div class="logo-icon">
                                ...
                                <a class="navbar-brand d-none d-lg-block" href="index.php"> <img src="../assets/images/logo/logo.png" alt="" height="50px" width="50px"
                              ></a>
          ...
          <div class="sidebar-nav" data-simplebar="true">
              ...
              <ul class="metismenu" id="menu">
                ...
                <li>
                  ...
                  <li> <a href="add_parent_category.php">Add Parent Category</a>
                    </li>
                    <li> <a href="Parent_Category.php">Parent Category</a>
                    </li>
                    ...
                    <li> <a href="add_slider.php">Add Slider</a>
                    </li>
                    <li> <a href="slider.php"> Slider</a>
                    </li>
                   
                    <li> <a href="customers_feedback.php">Customer's Feedback</a>
                    </li>
                <?php if($row['Role'] =='Admin'){?>
                    <li> <a href="add_user.php">Add Employees</a>
                    </li>
                    <li> <a href="">Customers Information</a>
                    </li>
                   <?php }?>
          ...
          <div class="sidebar-bottom dropdown dropup-center dropup">
              <div class="dropdown-toggle d-flex align-items-center px-3 gap-3 w-100 h-100" data-bs-toggle="dropdown">
                ...
                <div class="user-info" >
                  <h5 class="mb-0 user-name text-center"><?php echo $row['Name']?></h5>
                  <p class="mb-0 user-designation"><?php echo $row['Role']?></p>
                </div>
              </div>
